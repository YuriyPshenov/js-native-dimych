...
test('Greeting message should be correct for city', () => {
    ...
    // 1. cпособ через функцию
    expect(createMessage(city)).toBe('Good morning New York. It lives in New York 1000000 citizens!');

    // 2. способ через переменную
    expect(message).toBe('Good morning New York. It lives in New York 1000000 citizens!');
});
